...
import { useCta, useFooter } from "@/hooks/use-sanity"

// Default data (fallback)
const defaultCta = {
  title: "Не теряйте время — эвакуатор уже может быть в пути",
  description: "Напишите сейчас в Telegram, VK или Max — закрепим за вами ближайший экипаж и зафиксируем цену.",
  telegramUrl: "https://t.me/your_bot",
  telegramText: "Заказать в Telegram",
  vkUrl: "https://vk.com/your_group",
  vkText: "Написать во VK",
  maxUrl: "https://max.ru/your_profile",
  maxText: "Написать в Max",
}

const defaultFooter = {
  cityText: "Санкт-Петербург — круглосуточно, 24/7",
  telegramUrl: "https://t.me/your_bot",
  vkUrl: "https://vk.com/your_group",
}
    ...
    <footer className="bg-background border-t border-border py-10">
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          <a href={footer.telegramUrl} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors text-sm">
            Telegram
          </a>
          <a href={footer.vkUrl} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors text-sm">
            VK
          </a>
        </div>
      </div>
