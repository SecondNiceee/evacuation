    ...
    <section id="contacts" className="py-24 bg-card">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="text-muted-foreground mt-3">Отвечаем за 2-3 минуты</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-10">
          ...
          >
            ...
            <div>
              <h3 className="font-mono font-bold text-foreground text-lg mb-1">Telegram</h3>
              <p className="text-muted-foreground text-sm mb-4">
                Основной канал заказа. Telegram-бот: расчёт стоимости, отслеживание, история заказов.
              </p>
          ...
          >
            ...
            <div>
              <h3 className="font-mono font-bold text-foreground text-lg mb-1">ВКонтакте</h3>
              <p className="text-muted-foreground text-sm mb-4">
                Альтернативный канал связи. Здесь же — отзывы клиентов.
              </p>
              <span className="text-primary text-sm font-semibold group-hover:underline">
                Написать сообществу →
              </span>
          ...
          >
            ...
            <div>
              <h3 className="font-mono font-bold text-foreground text-lg mb-1">Max</h3>
              <p className="text-muted-foreground text-sm mb-4">
                Напишите в Max — удобный мессенджер от Mail.ru для быстрого заказа.
              </p>
              <span className="text-primary text-sm font-semibold group-hover:underline">
                Написать в Max →
              </span>
        ...
        <div className="flex flex-wrap justify-center gap-6 text-sm text-muted-foreground">
          <div className="flex items-center gap-2">
            ...
            <span>+7 (XXX) XXX-XX-XX (резерв)</span>
          </div>
          <div className="flex items-center gap-2">
            <Clock className="w-4 h-4 text-primary" />
            <span>Режим: 24/7, без выходных</span>
          </div>
          <div className="flex items-center gap-2">
            <Bot className="w-4 h-4 text-primary" />
            <span>Telegram-бот: автоматический расчёт стоимости</span>
          </div>
        </div>
      </div>
    </section>
